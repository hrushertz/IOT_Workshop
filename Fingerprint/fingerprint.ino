...
String postData ; 
String link = "http://192.168.0.105/biometricattendance/getdata.php"; 
int FingerID = 0;     
uint8_t id;
...
void SendFingerprintID( int finger ){
  ...
  http.begin(client,"http://hostel.jspmerp.in/one/api/sensorscanning"); 
...
WiFiClient client;
  ...
  http.begin(client,"http://hostel.jspmerp.in/one/api/sensorscanning");  //initiate HTTP request, put your Website URL or Your Computer IP 
